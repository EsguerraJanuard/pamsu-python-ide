...
export default function SignOutModal({ isOpen, onClose, onConfirm }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-sm transform overflow-hidden rounded-xl border border-border-subtle bg-bg-panel p-6 text-left align-middle shadow-2xl transition-all">
        ...
        <div className="mt-6 flex items-center justify-end gap-3">
          <button
            type="button"
            className="rounded-lg px-4 py-2 text-sm font-medium text-text-muted hover:bg-border-subtle transition-colors"
            onClick={onClose}
          >
            Cancel
          </button>
