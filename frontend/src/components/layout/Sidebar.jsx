  ...
  return (
    <>
      ...
      >
        ...
        <nav aria-label="Student navigation" className="flex-1 min-h-0 overflow-y-auto space-y-3.5 pr-0.5 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
